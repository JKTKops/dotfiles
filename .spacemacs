...
(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((intero-targets "Thcheme:lib" "Thcheme:exe:thcheme" "Thcheme:test:thcheme-test"))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(flycheck-error ((t (:background "red3" :underline nil))))
 '(flycheck-warning ((t (:background "peru" :box nil :underline nil))))
 '(font-lock-function-name-face ((t (:foreground "#FD971F"))))
 '(font-lock-keyword-face ((t (:foreground "brown1" :weight normal))))
 '(font-lock-variable-name-face ((t (:foreground "#AEFF29")))))
